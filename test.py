...
class Game(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.OffOrDef.setIcon(QIcon("GameUI\image\투명.png"))
        ...
        self.reset.setIcon(QIcon("GameUI\image\재시작.png"))
        ...
        self.exit.setIcon(QIcon("GameUI\image\종료.png"))
    ...
    def mukButtonClicked(self):
        self.OffOrDef.setIcon(QIcon("GameUI\image\mjp\묵.png"))
        self.display.setText("muk clicked")

    # jji button clicked
    def jjiButtonClicked(self):
        self.OffOrDef.setIcon(QIcon("GameUI\image\mjp\찌.png"))
        self.display.setText("jji clicked")

    # ppa button clicked
    def ppaButtonClicked(self):
        self.OffOrDef.setIcon(QIcon("GameUI\image\mjp\빠.png"))
        self.display.setText("ppa clicked")

    def OffOrDefClicked(self):
        self.OffOrDef.setIcon(QIcon("GameUI\image\물음표.png"))
        self.display.setText("OffOrDef clicked")
